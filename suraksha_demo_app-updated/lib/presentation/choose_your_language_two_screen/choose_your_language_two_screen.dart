import 'bloc/choose_your_language_two_bloc.dart';
import 'models/choose_your_language_two_model.dart';
...
class ChooseYourLanguageTwoScreen extends StatelessWidget {
  const ChooseYourLanguageTwoScreen({Key? key}) : super(key: key);

  static Widget builder(BuildContext context) {
    return BlocProvider<ChooseYourLanguageTwoBloc>(
        create: (context) => ChooseYourLanguageTwoBloc(
            ChooseYourLanguageTwoState(
                chooseYourLanguageTwoModelObj: ChooseYourLanguageTwoModel()))
          ..add(ChooseYourLanguageTwoInitialEvent()),
        child: ChooseYourLanguageTwoScreen());
  }
    ...
    return SafeArea(
        child: Scaffold(
            ...
            body: Container(
                ...
                padding: EdgeInsets.symmetric(horizontal: 35.h, vertical: 32.v),
                    ...
                    Expanded(
                        child: Padding(
                            ...
                            child: Column(children: [
                              ...
                              _buildLanguageRow(context, widgetText: "lbl".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl2".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl3".tr),
                              SizedBox(height: 28.v),
                              BlocSelector<
                                      ChooseYourLanguageTwoBloc,
                                      ChooseYourLanguageTwoState,
                                  ...
                                  builder: (context, malayalamController) {
                                    return CustomTextFormField(
                                        width: 168.h,
                              ...
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl5".tr)
                            ]))),
                    Expanded(
                        child: Padding(
                                      ...
                                      children: [
                                        ...
                                        Padding(
                                            padding: EdgeInsets.only(
                                                right: 37.h, bottom: 2.v),
                                            child: Text("lbl6".tr,
                                                style: CustomTextStyles
                                                    .titleLargeTiroDevanagariHindiBlack900))
                                      ])),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl7".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl8".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl9".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context,
                                  widgetText: "lbl10".tr),
                              SizedBox(height: 28.v),
                              _buildLanguageRow(context, widgetText: "lbl11".tr)
                            ])))
                  ]),
                  SizedBox(height: 5.v)
                ]))));
